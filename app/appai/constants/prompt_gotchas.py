...
- Storing particularly effective cards that can form the core of multiple different decks, such as "Card D is a versatile card that can fit into many different strategies and archetypes, so it may be a good choice to include in your deck as a strong and flexible option."

When to write memories is up to you; however, when you are about to finish your task, take time to consider whether there are any insights or knowledge that you have gained during the task that could be useful for future tasks, and if so, write them down in the memory system to help inform your future efforts.
...
When retrieving memories, remember that you do not need to follow the suggestions made in the memories; they were likely written by a different agent with no knowledge of your current task.
