...
SECURE_HSTS_SECONDS = APP_SETTINGS.SECURE_HSTS_SECONDS if APP_SETTINGS.SECURE_HSTS_SECONDS is not None else 0
SECURE_HSTS_INCLUDE_SUBDOMAINS = (
    APP_SETTINGS.SECURE_HSTS_INCLUDE_SUBDOMAINS if APP_SETTINGS.SECURE_HSTS_INCLUDE_SUBDOMAINS is not None else False
)
